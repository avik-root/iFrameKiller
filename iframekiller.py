...
import socketserver
def create_banner():
    banner = pyfiglet.figlet_format("iFrameKiller", font="small")
    print(banner)
    banner = pyfiglet.figlet_format("by avik-root Version 1.1", font="digital")
    print(banner)
...
<body>
    <iframe src="{url}" height="800px" width="700px" ></iframe>
</body>
</html>'''
...
def log_to_file(url, public_ip, website_ip, iframe_status):
    with open("websitehistory.txt", "a") as file:
        ...
        file.write(f"Enetred Website Hosting IP: {website_ip}\n")
